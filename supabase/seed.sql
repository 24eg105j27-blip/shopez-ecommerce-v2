...
-- Categories: Watches, Phones, Shoes, Headphones (+ existing ones)
...
-- 10 Products across Watches, Phones, Shoes, Headphones
...
-- Banners
INSERT INTO banners (banner_image, title, description) VALUES
  ('https://images.pexels.com/photos/230544/pexels-photo-230544.jpeg?auto=compress&cs=tinysrgb&w=1200', 'Summer Sale is Live!', 'Up to 60% off on Electronics, Fashion & more'),
  ('https://images.pexels.com/photos/5632399/pexels-photo-5632399.jpeg?auto=compress&cs=tinysrgb&w=1200', 'New Arrivals', 'Check out the latest trends in Fashion'),
  ('https://images.pexels.com/photos/279618/pexels-photo-279618.jpeg?auto=compress&cs=tinysrgb&w=1200', 'Free Shipping', 'On orders above ₹500')
ON CONFLICT DO NOTHING;
